...
import be.lmenten.avr.ui.rsyntax.AvrAssemblerTokenMaker;
 ...
 * @version 1.0
 */
public class AvrAssemblerEditorPane
	extends JRootPane
	implements HyperlinkListener, SyntaxConstants
{
	...
	AvrAssemblerEditorPane()
	{
		AvrAssemblerTokenMaker.register();

		// --------------------------------------------------------------------

		textArea = createTextArea();
		textArea.setSyntaxEditingStyle( AvrAssemblerTokenMaker.MIME_TYPE );
	...
	private static Action createCopyAsStyledTextAction(String themeName) throws IOException {
		...
		Theme theme = Theme.load(AvrAssemblerEditorPane.class.getResourceAsStream(resource));
	...
	private JMenuBar createMenuBar() {
		...
		addSyntaxItem( "AVR assembler", "test.asm", "text/avrasm", bg, menu);
...
//		menu.getItem(0).setSelected(true);
	...
	private class AboutAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(AvrAssemblerEditorPane.this,
