	...
	implements AvrRegisterIndex
{
	...
	private AvrRegistersYZ( String extendedRegisterName, AvrRegisters upperRegister, AvrRegisters lowerRegister  )
	{
	 ...
	 * @return
	 */
	public static AvrRegistersYZ lookupByOperandCode( int code )
	{
		for( AvrRegistersYZ r : values() )
		{
