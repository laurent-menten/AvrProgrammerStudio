	...
	extends AbstractInstruction_Rd_Rr
{
	...
	public AND( InstructionSet entry, int data )
	{
		super( InstructionSet.AND, data );
	}

	public AND( InstructionSet entry, AvrRegisters rd, AvrRegisters rr )
	{
		super( entry, rd, rd );
	}
	...
	public AND( AvrRegisters rd, AvrRegisters rr )
	{
		super( InstructionSet.AND, rd, rr );
	}
