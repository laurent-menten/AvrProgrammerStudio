	...
	extends AbstractInstruction_Rx4_K8
{
	...
	public ANDI( InstructionSet entry, int data )
	{
		super( entry, data );
	}

	protected ANDI( InstructionSet entry, AvrUpperRegisters rd, byte K )
	{
		super( entry, rd, K );
	}
	...
	public ANDI( AvrUpperRegisters rd, byte K )
	{
		this( InstructionSet.ANDI, rd, K );
	}
