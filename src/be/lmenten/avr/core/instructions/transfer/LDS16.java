...
import be.lmenten.avr.core.instructions.AbstractInstruction_Rx4_k7;
 ...
 */
public class LDS16
	extends AbstractInstruction_Rx4_k7
{
	// ========================================================================
	// === CONSTRUCTOR(S) =====================================================
	// ========================================================================

	public LDS16( InstructionSet entry, int data )
	{
		super( InstructionSet.LDS_16, data );
	}

	// ------------------------------------------------------------------------

	public LDS16( AvrUpperRegisters rd, int k )
	{
		super( InstructionSet.LDS_16, rd, k );
	}
