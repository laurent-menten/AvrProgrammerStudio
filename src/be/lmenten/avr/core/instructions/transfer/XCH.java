	...
	extends AbstractInstruction_Rx
{
	...
	public XCH( InstructionSet entry, int data )
	{
		super( InstructionSet.XCH, data );
	}

	// ------------------------------------------------------------------------

	public XCH( AvrRegisters rd )
	{
		super( InstructionSet.XCH, rd );
	}
	...
	public void execute( Core core )
	{
		...
		byte tmp = (byte) zCell.getData();
		zCell.setData( rd.getData() );
		rd.setData( tmp );
