	...
	extends Instruction
{
	...
	private final boolean zInc;

	// ========================================================================
	// === CONSTRUCTOR(S) =====================================================
	// ========================================================================

	public SPM( InstructionSet entry, int data )
	{
		super( InstructionSet.SPM, data );

		zInc = ((data & 0b0000_0000_0001_0000) == 0b0000_0000_0001_0000);
	}
	...
	public SPM( boolean zInc )
	{
		super( InstructionSet.SPM );
