 ...
 * @since 1.0
 */
public class AbstractInstruction_Rx4
	extends Instruction
{
	private final AvrUpperRegisters rx;

	// ========================================================================
	// === CONSTRUCTOR(s) =====================================================
	// ========================================================================

	public AbstractInstruction_Rx4( InstructionSet entry, int data )
	{
		super( entry, data );
		...
		this.rx = AvrUpperRegisters.lookupByOperandCode( rxOperanCode );
	}

	// ------------------------------------------------------------------------

	public AbstractInstruction_Rx4( InstructionSet entry, AvrUpperRegisters rx )
	{
		super( entry );
	...
	public AvrUpperRegisters getRx()
	{
		return rx;
	}
	// ========================================================================
