	...
	extends AbstractInstruction_Rd3_Rr3
{
	...
	public FMULS( InstructionSet entry, int data )
	{
		super( InstructionSet.FMULS, data );
	}

	// ------------------------------------------------------------------------

	public FMULS( AvrLowUpperRegisters rd, AvrLowUpperRegisters rr )
	{
		super( InstructionSet.FMULS, rd, rr );
	}
