...
import be.lmenten.avr.core.instructions.bit.ROL;
	...
	extends AbstractInstruction_Rd_Rr
{
	...
	public ADC( InstructionSet entry, int data )
	{
		super( entry, data );
	}

	// for ROL Rd
	protected ADC( InstructionSet entry, AvrRegisters rd, AvrRegisters rr )
	{
		super( entry, rd, rr );
	}
	...
	public ADC( AvrRegisters rd, AvrRegisters rr )
	{
		this( InstructionSet.ADC, rd, rr );
	}
	...
	public void execute( Core core )
	{
		...
		Value r = rd.compute( (a,b,c) -> { return (byte)(a + b + c); }, rr, core.SREG.c() );
