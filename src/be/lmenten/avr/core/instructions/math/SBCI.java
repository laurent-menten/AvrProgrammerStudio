	...
	extends AbstractInstruction_Rx4_K8
{
	...
	public SBCI( InstructionSet entry, int data )
	{
		super( InstructionSet.SBCI, data );
	}

	// ------------------------------------------------------------------------

	public SBCI( AvrUpperRegisters rd, byte K )
	{
		super( InstructionSet.SBCI, rd, K );
	}
	...
	public void execute( Core core )
	{
		...
		Value r = rd.compute( (a,b,c) -> { return (byte)(a - b - c); }, K, core.SREG.c()  );
