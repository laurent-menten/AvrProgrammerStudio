	...
	extends AbstractInstruction_Rd3_Rr3
{
	...
	public FMUL( InstructionSet entry, int data )
	{
		super( InstructionSet.FMUL, data );
	}

	// ------------------------------------------------------------------------

	public FMUL( AvrLowUpperRegisters rd, AvrLowUpperRegisters rr )
	{
		super( InstructionSet.FMUL, rd, rr );
	}
