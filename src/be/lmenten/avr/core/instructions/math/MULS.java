	...
	extends AbstractInstruction_Rd4_Rr4
{
	...
	public MULS( InstructionSet entry, int data )
	{
		super( InstructionSet.MULS, data );
	}

	// ------------------------------------------------------------------------

	public MULS( AvrUpperRegisters rd, AvrUpperRegisters rr )
	{
		super( InstructionSet.MULS, rd, rr );
	}
