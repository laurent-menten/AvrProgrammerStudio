	...
	extends AbstractInstruction_k7_s3
{
	...
	public BRBC( InstructionSet entry, int data )
	{
		super( entry, data );
	}

	// for BRBC BRHC, BRID, BRNE, BRPL, BRSH, BRTC, BRVC, BREQ
	protected BRBC( InstructionSet entry, AvrStatusRegisterBits s, int k )
	{
	...
	public BRBC( AvrStatusRegisterBits s, int k )
	{
		this( InstructionSet.BRBC, s, k );
	}
